...
public:
    ...
    friend istream& operator>>(istream& input, bookCopy& obj)
    {
        ...
        while (!(obj.Flag == "available" || obj.Flag == "notAvailable"))
        {
...
public:
    ...
    void push(bookCopy element)
    {
        ...
        last->Next_Node = container; //new link to th next node by putting the address of the new node in the second part of the previous node
